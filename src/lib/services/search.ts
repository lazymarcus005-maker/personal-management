 ...
 * by the given user id; area/project/type/date filters are pushed into the
 * database queries before any limit so filters can't hide matching rows
 * behind an arbitrary result window.
 *
 * Shared by the web app's /api/search route and the MCP search tool.
 */
